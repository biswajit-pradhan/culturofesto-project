    ...
    <div className="container">
      ...
      <form onSubmit={handleSubmit}>
        <div className="form-group">
          ...
          <input
            type="text"
            className={`form-control ${errors.bookingDataId && 'is-invalid'}`}
            value={bookingDataId}
            onChange={handleBookingDataIdChange}
          />
          {errors.bookingDataId && <div className="invalid-feedback">{errors.bookingDataId}</div>}
        </div>
        <div className="form-group">
        ...
        <div className="form-group">
          ...
          />
          {errors.cvvNumber && <div className="invalid-feedback">{errors.cvvNumber}</div>}
        </div>
        <div className="form-group">
          ...
          />
          {errors.otpNumber && <div className="invalid-feedback">{errors.otpNumber}</div>}
        </div>
        <div className="form-group">
          <label>Total Ticket Price:</label>
          <input
            type="number"
            className={`form-control ${errors.totalTicketPrice && 'is-invalid'}`}
            value={totalTicketPrice}
            onChange={handleTotalTicketPriceChange}
          />
          {errors.totalTicketPrice && <div className="invalid-feedback">{errors.totalTicketPrice}</div>}
        </div>
        <br/>
